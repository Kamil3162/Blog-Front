...
import {NavigationElement} from "../../../assets/styledCss/NavbarStyled";
        ...
        <LeftPanelContainer>
            {
                ...
                <LeftPanelElement>
                    <LeftPanelElementIcon>
                        <img src={listview} width="30px" height="30px" onClick={handlePanelVisibility}/>
                    </LeftPanelElementIcon>
                </LeftPanelElement>
